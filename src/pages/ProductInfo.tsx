...
export default function ProductInfo<Type>() {
    ...
    const columns: GridColDef[] = [
        ...
        {field: 'applyDt', headerName: '모집기간', width: 120},
...
const getReviewStatus = (value: 'waiting' | 'process' | 'deny' | 'approve' | 'confirm' | 'contract' | 'register') => {
    const datas = {
        waiting: '대기중',
        process: '심사중',
        deny: '반려',
...
const getProductStatus = (value: 'reviewing' | 'reviewed' | 'recruiting' | 'recruited' | 'redeeming' | 'redeemed' | 'overdue') => {
    const datas = {
        reviewing: '심사중',
        reviewed: '심사 완료',
        recruiting: '모집중',
